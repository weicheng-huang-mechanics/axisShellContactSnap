...
setInput::setInput()
{
  ...
  AddOption("totalCompress", "totalCompress", totalCompress);
  AddOption("nv", "nv", nv);
  AddOption("inputPressure", "inputPressure", inputPressure);
  AddOption("delta", "delta", delta);
  AddOption("height", "height", height);
  AddOption("stiffness", "stiffness", stiffness);
  AddOption("dBar", "dBar", dBar);
  AddOption("ballRadius", "ballRadius", ballRadius);
  AddOption("massSpeed", "massSpeed", massSpeed);
}
